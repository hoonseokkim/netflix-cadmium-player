...
features.gridCell_14 = createCategoricalFeature(); // 64  (_Ajc)
features.gridCell_15 = createCategoricalFeature(); // 65  (_Bjc)
features.gridCell_16 = createCategoricalFeature(); // 66  (_Cjc)
features.gridCell_17 = createCategoricalFeature(); // 67  (_Djc)
features.gridCell_18 = createCategoricalFeature(); // 68  (_Ejc)
features.gridCell_19 = createCategoricalFeature(); // 69  (_Fjc)
features.gridCell_20 = createCategoricalFeature(); // 70  (_Gjc)
features.gridCell_21 = createCategoricalFeature(); // 71  (_Hjc)
features.gridCell_22 = createCategoricalFeature(); // 72  (_Ijc)
features.gridCell_23 = createCategoricalFeature(); // 73  (_Jjc)
features.gridCell_24 = createCategoricalFeature(); // 74  (_Kjc)
features.gridCell_25 = createCategoricalFeature(); // 75  (_Ljc)
features.gridCell_26 = createCategoricalFeature(); // 76  (_Mjc)
features.gridCell_27 = createCategoricalFeature(); // 77  (_Njc)
features.gridCell_28 = createCategoricalFeature(); // 78  (_Ojc)
features.gridCell_29 = createCategoricalFeature(); // 79  (_Pjc)
features.gridCell_30 = createCategoricalFeature(); // 80  (_Qjc)
features.gridCell_31 = createCategoricalFeature(); // 81  (_Rjc)
features.gridCell_32 = createCategoricalFeature(); // 82  (_Sjc)
features.gridCell_33 = createCategoricalFeature(); // 83  (_Tjc)
features.gridCell_34 = createCategoricalFeature(); // 84  (_Ujc)
features.gridCell_35 = createCategoricalFeature(); // 85  (_Vjc)
features.gridCell_36 = createCategoricalFeature(); // 86  (_Wjc)
features.gridCell_37 = createCategoricalFeature(); // 87  (_Xjc)
features.gridCell_38 = createCategoricalFeature(); // 88  (_Yjc)
features.gridCell_39 = createCategoricalFeature(); // 89  (_Zjc)
...
features.gridCell_67 = createCategoricalFeature(); // 117 (_Akc)
features.gridCell_68 = createCategoricalFeature(); // 118 (_Bkc)
features.gridCell_69 = createCategoricalFeature(); // 119 (_Ckc)
features.gridCell_70 = createCategoricalFeature(); // 120 (_Dkc)
features.gridCell_71 = createCategoricalFeature(); // 121 (_Ekc)
features.gridCell_72 = createCategoricalFeature(); // 122 (_Fkc)
features.gridCell_73 = createCategoricalFeature(); // 123 (_Gkc)
features.gridCell_74 = createCategoricalFeature(); // 124 (_Hkc)
features.gridCell_75 = createCategoricalFeature(); // 125 (_Ikc)
features.gridCell_76 = createCategoricalFeature(); // 126 (_Jkc)
features.gridCell_77 = createCategoricalFeature(); // 127 (_Kkc)
features.gridCell_78 = createCategoricalFeature(); // 128 (_Lkc)
