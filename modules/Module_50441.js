...
var g, f, e, h, k, l;
function d(m) {
    return "undefined" === typeof m ? false : m;
}
function p(m) {
    if (m && m.length) {
        if (k === Zb.hs || k === Zb.js)
    ...
    return k === Zb.hs || k === Zb.js ? ("encrypt decrypt sign verify deriveKey wrapKey unwrapKey").split(" ") : ("encrypt decrypt sign verify deriveKey wrap unwrap").split(" ");
}
function c(m) {
